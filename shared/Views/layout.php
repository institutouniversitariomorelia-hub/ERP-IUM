                                ...
                                <div class="modal-body" style="max-height: 70vh; overflow-y: auto;">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            ...
                                            <input id="eg_fecha" name="fecha" type="date" class="form-control form-control-sm" value="<?php echo date('Y-m-d'); ?>" required>
                                        </div>
                                        <div class="col-md-4">
                ...
                <form id="formIngreso">
                    ...
                    <div class="modal-body" style="max-height: 70vh; overflow-y: auto;">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4"><label for="in_id_categoria" class="form-label">Concepto <span class="text-danger">*</span></label><select id="in_id_categoria" name="id_categoria" class="form-select form-select-sm" required></select></div>
            ...
            <div class="modal-content">
                <form id="formCategoria">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" id="categoria_no_borrable" name="no_borrable">
                        
                        <div class="mb-3">
                            <label for="cat_nombre" class="form-label">Nombre de Categoría</label>
                            <input id="cat_nombre" name="nombre" type="text" class="form-control" required>
                        </div>
                        
                        <div class="mb-3">
                            <label for="cat_tipo" class="form-label">Tipo de Flujo</label>
                            <select id="cat_tipo" name="tipo" class="form-select" required>
                                <option value="Ingreso">Ingreso</option>
                                <option value="Egreso">Egreso</option>
                            </select>
                        </div>
                        
                        <div class="mb-3" id="div_cat_concepto" style="display:none;">
                            <label for="cat_concepto" class="form-label">Concepto (solo Ingresos)</label>
                            <select id="cat_concepto" name="concepto" class="form-select">
                                <option value="">Seleccionar...</option>
                                <option value="Registro Diario">Registro Diario</option>
                                <option value="Titulaciones">Titulaciones</option>
                                <option value="Inscripciones y Reinscripciones">Inscripciones y Reinscripciones</option>
                            </select>
                            <small class="form-text text-muted">Requerido solo para categorías de tipo Ingreso</small>
                        </div>
                        
                        <div class="mb-3">
                            <label for="cat_descripcion" class="form-label">Descripción</label>
                            <textarea id="cat_descripcion" name="descripcion" class="form-control" rows="2"></textarea>
                        </div>
                        
                        <div class="alert alert-warning mb-0" id="alert_categoria_protegida" style="display:none;">
                            <small><strong>Nota:</strong> Esta es una categoría del sistema y no puede ser eliminada.</small>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
