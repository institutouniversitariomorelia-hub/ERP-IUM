                    ...
                    <?php else: ?>
                        ...
                        ?>
                            <tr data-fecha="<?php echo htmlspecialchars($ingreso['fecha'] ?? ''); ?>">
                                ...
                                <td>    
                                <span style="display:none;"><?php echo htmlspecialchars($ingreso['id'] ?? ''); ?></span>
                                <?php echo htmlspecialchars($ingreso['alumno'] ?? 'N/A'); ?>
                                <br class="d-md-none">
                                <small class="d-md-none text-muted"><?php echo htmlspecialchars($ingreso['nombre_categoria'] ?? ''); ?></small>
                                </td>
            ...
            ajaxCall('presupuesto', 'getReembolsoPresupuestos', {}, 'GET')
                .done(function(pres) {
                    ...
                    var prefill = {
                        ...
                        // Para reembolsos usar categoría fija ID 224 (IUM REEMBOLSOS) y presupuesto fijo ID 11
                        id_categoria: 224,
        ...
        <div class="modal-content border-danger">
            ...
            <div class="modal-body">
                <form id="formReembolso" method="post" action="index.php?controller=egreso&action=save">
                    ...
                    <!-- Estos campos los fuerza el backend (11/224); se mantienen ocultos -->
                    <!-- Nota: Usaremos selects visibles para que el usuario vea lo que se forzará -->
                    <!-- Los valores se establecerán programáticamente a 11 y 224 -->
