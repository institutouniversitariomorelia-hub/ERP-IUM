<?php
// src/Egresos/Models/EgresoModel.php (CON JOIN PARA NOMBRE CATEGORÍA)
...
class EgresoModel {
    ...
    public function updateEgreso($folio_egreso, $data) {
        ...
        $bindResult = $stmt->bind_param( "ssds" . "sssiiii",
            $proveedor, $descripcion, $monto, $fecha,
            $destinatario, $forma_pago, $doc_amparo,
            $id_user, $id_presupuesto, $id_categoria,
            $folio_egreso
